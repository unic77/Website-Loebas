    ...
    return (
      <div className="w-screen h-screen pt-20 bg-white">
        <div className="mx-auto bg-white grid max-w-7xl gap-x-8 px-6 lg:px-8">
          ...
          <ul role="list" className="gap-x-8 py-10 flex flex-wrap justify-center">
            {people.map((person) => (
              <li key={person.name}>
                <div className="flex bg-white md:items-center gap-x-6 listElement shadow-lg border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400">
